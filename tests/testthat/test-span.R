...
test_that("`span` should deal with normal and abnormal data", {
  ...
  expect_named(result_fds, c("max_span", "mean_span", "nc", "is_normal"))
  expect_equal(result_fds$max_span, 16)
  expect_equal(result_fds$mean_span, 16.5, tolerance = 0.1)
  expect_equal(result_fds$nc, 133)
  ...
  expect_named(result_abnormal, c("max_span", "mean_span", "nc", "is_normal"))
